package hafizdwp.app.androidmvpexample;
...
import hafizdwp.app.androidmvpexample.data.pojo.ApiGithubErrorPojo;
import retrofit2.adapter.rxjava.HttpException;

import static java.net.HttpURLConnection.HTTP_UNAUTHORIZED;

/**
 * Created by fahmi on 25/07/2016.
 */
...
//            return errorResponse.getMeta().getMessage();
            ApiGithubErrorPojo errorResponse = new Gson().fromJson(jsonString, ApiGithubErrorPojo.class);
